...
//     */
//    public static int numeroPedidos=-1;
     ...
     */
    public Pedido( int id , String nombreCliente, String direccionCliente)
    {	
        this.idPedido = id;
    ...
    //aquí se hacen algunas modificaciones por lo de las excepciones
    public void agregarProducto( Producto nuevoProducto ) throws ProductoRepetidoException, ProductoFaltanteException
    {
...
//    }
    ...
    /**
     * Guarda la factura del pedido en el archivo indicado.
     * @param archivo El archivo donde debe quedar almacenada la factura del pedido.
     * @throws FileNotFoundException Se lanza esta excepción si no se puede crear el archivo para guardar la factura.
     */
    public void guardarFactura(File archivo) throws FileNotFoundException {
        if (archivo == null) {
